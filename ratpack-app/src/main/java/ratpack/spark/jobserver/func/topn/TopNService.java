 ...
 */
package ratpack.spark.jobserver.func.topn;
...
import ratpack.spark.jobserver.func.topn.model.UserActivityCounter;
...
public class TopNService {
  ...
  public Promise<Result<List<UserActivityCounter>>> apply(String jobName, CalcTopN request, String inputFS, String outputFS) {
    return containersService
      .getJobContainer(Strings.isNullOrEmpty(jobName) ? "TopN" : jobName, "spark.func.topn.TopNApp"/*sparkJobsConfig.getTopNClassName()*/)
      .flatMap(container -> {
