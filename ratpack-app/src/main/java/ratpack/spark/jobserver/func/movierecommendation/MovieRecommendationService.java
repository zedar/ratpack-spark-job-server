 ...
 */
package ratpack.spark.jobserver.func.movierecommendation;
...
import ratpack.spark.jobserver.func.movierecommendation.dto.Request;
import ratpack.spark.jobserver.func.movierecommendation.model.MovieRecommendation;
...
public class MovieRecommendationService {
  ...
  public Promise<Result<List<MovieRecommendation>>> apply(Request request, String inputFS, String outputFS) {
    return containersService
      .getJobContainer("MovieRecommendation", "spark.func.movierecommendation.MovieRecommendationApp"/*sparkJobsConfig.getMovieRecommendationClassName()*/)
      .flatMap(container -> {
